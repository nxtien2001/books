...
@section('title', 'Admin')
@section('route', 'Thêm mới thành viên')
            ...
            <form action="{{route('admin.users.store')}}" method="post">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input autocomplete="off" id="" type="text" name="fullname" value="{{old('fullname')}}" class="form-control" id="" placeholder="">
                        @error('fullname')
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input autocomplete="off" id="" type="email" name="email" value="{{old('email')}}" class="form-control" id="" placeholder="">
                        @error('email')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input autocomplete="off" id="slug" type="text" name="phone" value="{{old('phone')}}" class="form-control" id="" placeholder="">
                        @error('phone')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
