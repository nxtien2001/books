        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="dichvu d-flex align-items-center">
                    <img src="{{asset('theme/client/images/icon-books.png')}}" alt="icon-books">
                    <div class="noidung">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="dichvu d-flex align-items-center">
                    <img src="{{asset('theme/client/images/icon-ship.png')}}" alt="icon-ship">
                    <div class="noidung">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="dichvu d-flex align-items-center">
                    <img src="{{asset('theme/client/images/icon-gift.png')}}" alt="icon-gift">
                    <div class="noidung">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="dichvu d-flex align-items-center">
                    <img src="{{asset('theme/client/images/icon-return.png')}}" alt="icon-return">
                    <div class="noidung">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-xs-6">
                <div class="lienket">
                    ...
                    <img src="{{asset('theme/client/images/dang-ky-bo-cong-thuong.png')}}" alt="dang-ky-bo-cong-thuong">
                </div>
            </div>
            <div class="col-md-3 col-xs-6">
                <div class="ptthanhtoan">
                    <h3 class="header text-uppercase font-weight-bold">Phương thức thanh toán</h3>
                    <img src="{{asset('theme/client/images/visa-payment.jpg')}}" alt="visa-payment">
                    <img src="{{asset('theme/client/images/master-card-payment.jpg')}}" alt="master-card-payment">
                    <img src="{{asset('theme/client/images/jcb-payment.jpg')}}" alt="jcb-payment">
                    <img src="{{asset('theme/client/images/atm-payment.jpg')}}" alt="atm-payment">
                    <img src="{{asset('theme/client/images/cod-payment.jpg')}}" alt="cod-payment">
                    <img src="{{asset('theme/client/images/payoo-payment.jpg')}}" alt="payoo-payment">
                </div>
            </div>
        </div>
    </div>
